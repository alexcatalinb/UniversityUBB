...
namespace UniversityUBB.Controllers
{
    [Authorize]
    public class UniversityUBBController : Controller
    {
        private UserManager<IdentityUser> userManager;

        public IdentityUser user { get; private set; }

        public UniversityUBBController(UserManager<IdentityUser> userMgr)
        {
            userManager = userMgr;
        }
        ...
        {
            IdentityUser IdentityUseruser = await
                        userManager.GetUserAsync(HttpContext.User);
